...
# scripts run even when a global `core.hooksPath` (e.g. Aikido secrets)
# would otherwise bypass lefthook.
#
# - pre-commit: optional Aikido secrets scan + rustfmt (when *.rs staged)
