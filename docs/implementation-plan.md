...
| Phases 2–3 | Phase 2 started: X1.1–X1.3 and X1.8 done (Wasmtime host, `type: wasm`, transform test, Rust guest template; Postgres-backed ledger + checkpoint store). Open without AWS: X1.4 OCI, X1.5 Azure/GCS, X1.7 `ai.generate`. Cloud-blocked: S2.2 frontier, P2.1 acceptance. Phase 3 not started. |
